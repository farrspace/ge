...
- [Gaming Experience Improvement Project](#gaming-experience-improvement-project)
  - [Benefits for players](#benefits-for-players)
  - [Benefits for developers](#benefits-for-developers)
- [The Guidelines](#the-guidelines)
  - [Controls](#controls)
      - [MENU\_INTERACTION](#menu_interaction)
      - [HOLD\_TO\_ACTIVATE](#hold_to_activate)
      - [ALLOW\_CONTROL\_REMAPPING](#allow_control_remapping)
      - [NORMAL\_MOUSE\_SPEED](#normal_mouse_speed)
      - [CHANGE\_CONTROLS\_WHILE\_PLAYING](#change_controls_while_playing)
  - [Graphics](#graphics)
    - [Resolution](#resolution)
      - [DEFAULT\_RESOLUTION](#default_resolution)
      - [ULTRAWIDE\_SUPPORT](#ultrawide_support)
    - [Performance](#performance)
      - [SHOW\_FPS](#show_fps)
      - [FRAMERATE\_LIMIT](#framerate_limit)
      - [GRAPHICS\_BENCHMARK](#graphics_benchmark)
    - [Effects](#effects)
      - [MOTION\_BLUR](#motion_blur)
      - [DEPTH\_OF\_FIELD](#depth_of_field)
      - [HEAD\_BOBBING](#head_bobbing)
    - [Graphics Options](#graphics-options)
      - [SUPPORT\_WINDOWED](#support_windowed)
      - [CONFIRM\_RESOLUTION](#confirm_resolution)
      - [CHANGE\_GRAPHICS\_FROM\_GAME](#change_graphics_from_game)
  ...
  - [Desktop interaction](#desktop-interaction)
      - [ALT\_TAB](#alt_tab)
      - [BACKGROUND\_FRAMERATE](#background_framerate)
      - [AUTO\_RESTART](#auto_restart)
